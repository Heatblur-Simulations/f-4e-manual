...
This can be put into the sight depression knob in order to align the reticle with the target
for a manual MIL bombing solution.
...
a [release advance](../systems/weapon_systems/wrcs.md#release-advance-control).
