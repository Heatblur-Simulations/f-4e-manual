...
Dependent on mode, the illuminated display shows P for Plain mode
(<num>1</num>), or C for Cipher mode (<num>2</num>).

> 💡 UHF communications require the system be in Plain mode, even with system
> power off, barring usage and monitoring of guard channel.
...
| Inertial Nav Sys Out | The light will illuminate if the Inertial Navigation system is either out or off.                                                                                                                               | Tank 7 Fuel         | The light will illuminate if Tank 7 fuel transfer valve fails to open.                                                                       |                      |                                                                                                                                                         |
