...
A fourth indicator may appear as part of the SYS TEST or power up cycle. This
...
This button is also used when switching the threat files. Exact procedure is
...
| ![rwr_s_symbol.jpg](../../img/rwr_s_symbol.jpg)                         | SA-6 Kub "Straight Flush" SR, Roland SR, C-RAM Phalanx SR, PPRU-1 "Dog Ear", HQ-7 SR, Hawk CWAR, NASAMS, Rapier Dagger, SA-11 Snow Drift, SA-10 "Big Bird" & "Clam Shell", IRIS-T SLM |
...
| ![rwr_nine_symbol.jpg](../../img/rwr_nine_symbol.jpg)                   | CV 1143.5 Kuznetsov, Cruiser Moskva, Project 22160, Project 22160 with Tor-M2KM                                                                         |
...
> 💡 The presence of a tracking radar does not necessarily indicate a lock, that
> the weapon platform intents to shoot or that the own aircraft is the target.
> However, in practice this is very often the case.

> 💡 Symbols **S** and **U** require activating the **SEARCH** and **UNKNOWN**
> mode respectively to be shown on the screen.

> 💡 The following threats and their indications (except launch) are applicable
> only for the respective threat table that the ALR-46 is currently using. For
> example, the Rezky's tracking radar will display as a **4** on the sea file
> (as listed below) but will display as an **8** when using the land file. It is
> important to be using the correct threat table for the expected threats or
> confusion may occur.
...
| Slava                      | S (Multiple radars some U) | 9    | ❌     |
