...
- 如果拉起指示灯亮起，那么飞行员需要执行平稳的拉起机动来达成发射参数。平滑将飞机压回地平线以及如有
  必要，继续执行浅爬升剖面。
- 如果俯冲指示灯亮起，那么表示需要执行可控俯冲机动指向目标。通常在靠近目标才开始攻击时才会出现俯冲
  指示灯亮起，所以确保快速地准备好进行攻击，因为靠近辐射源将增加还击的风险。
- 水平指示灯亮起表示飞机正在正确的导弹发射指向上。在某些情况下，指示灯可能会立刻亮起或在执行其它机
  动后不久亮起，来确认准备好发射导弹。
...
| 导引头       |  SA-2   | SA-3 | SA-5 |   SA-6    | SA-8 |    SA-10     | SA-11 | SA-13 | SA-15 (道尔-M1) | SA-15 (道尔-M2) | SA-19 | SA-22 | EWR  |
| ------------ | :-----: | :--: | :--: | :-------: | :--: | :----------: | :---: | :---: | :-------------: | :-------------: | :---: | :---: | :--: |
